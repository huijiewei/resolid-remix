  ...
  if (isRouteErrorResponse(error)) {
    return (
      <div className={"relative mx-auto mt-20 flex h-full max-w-3xl items-center justify-center p-4"}>
        <svg className={"absolute inset-0 fill-black/5"} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 362 145">
        ...
        <div className={"prose dark:prose-invert z-10 mt-28 max-w-xl text-center"}>
          <h1>页面未找到</h1>
          <p>
